...
function draw()
{
    ...
    remove_decimal=Math.floor(InNumberRightWristY);
    if (RightWristY>LeftWristY&&RightWristY>0)
    {
        song1.stop();
        song2.play();
        document.getElementById("volume").innerHTML="Da sOnG Is sOnG 2, yea idk what this song accually is";
    }
    }
}
